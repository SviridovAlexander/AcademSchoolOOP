...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("First element: " + list.getFirstValue());

        int indexToGet = 1;
        System.out.println("Element at index " + indexToGet + ": " + list.getValueAtIndex(indexToGet));

        int newValue = 99;
        int oldValue = list.setValueAtIndex(indexToGet, newValue);
        System.out.println("Old value at index " + indexToGet + ": " + oldValue);
        System.out.println("New value at index " + indexToGet + ": " + list.getValueAtIndex(indexToGet));
        ...
        SingleLinkedList<Integer> copyList = list.copy();
        System.out.println("Copied List elements: " + copyList.toString());
    }
}
